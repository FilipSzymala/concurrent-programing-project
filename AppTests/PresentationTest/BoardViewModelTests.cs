...
public sealed class BoardViewModelTests
{
    ...
    public void BallListItem_UpdateFrom_MapsPositionCorrectly()
    {
        ...
        item.UpdateFrom(new FakeBallStatus(id: 0, x: 123.5, y: 456.7, diameter: 50, r: 0, g: 0, b: 0));
    ...
    public void BallListItem_UpdateFrom_MapsDiameterCorrectly()
    {
        ...
        item.UpdateFrom(new FakeBallStatus(id: 0, x: 0, y: 0, diameter: 42, r: 0, g: 0, b: 0));
    ...
    public void BallListItem_UpdateFrom_MapsColorFromRgb()
    {
        ...
        item.UpdateFrom(new FakeBallStatus(id: 0, x: 0, y: 0, diameter: 10, r: 100, g: 150, b: 200));
    ...
    public void BallListItem_UpdateFrom_RaisesPropertyChangedForPosition()
    {
        ...
        item.UpdateFrom(new FakeBallStatus(id: 0, x: 10, y: 20, diameter: 30, r: 0, g: 0, b: 0));
    ...
    public void BallListItem_UpdateFrom_PositionChanges_RaisesPropertyChanged()
    {
        ...
        item.UpdateFrom(new FakeBallStatus(id: 0, x: 15, y: 25, diameter: 30, r: 0, g: 0, b: 0));
